...
namespace Orcus.Service.Commander.Logging
{
    internal static class MvcCoreLoggerExtensions
    {
        ...
        private static readonly string[] _noFilters = {"None"};
        ...
        private static readonly Action<ILogger, string, Type, string, Type, Exception>
        ...
        private static readonly Action<ILogger, Type, string, Exception>
        ...
        private static readonly Action<ILogger, string, Type, Exception>
        ...
        private static readonly Action<ILogger, string, MediaTypeCollection, Exception>
        ...
        private static readonly Action<ILogger, IEnumerable<MediaTypeSegmentWithQuality>, Exception>
        ...
        private static readonly Action<ILogger, DateTimeOffset?, DateTimeOffset?, Exception>
            _ifUnmodifiedSincePreconditionFailed;

        private static readonly Action<ILogger, DateTimeOffset?, DateTimeOffset?, Exception>
            _ifRangeLastModifiedPreconditionFailed;

        private static readonly Action<ILogger, EntityTagHeaderValue, EntityTagHeaderValue, Exception>
            _ifRangeETagPreconditionFailed;

        private static readonly
            Action<ILogger, IEnumerable<MediaTypeSegmentWithQuality>, MediaTypeCollection, Exception>
        ...
        private static readonly Action<ILogger, MediaTypeCollection, Exception>
        ...
        public static void RegisteredOutputFormatters(this ILogger logger,
        ...
        {
            _selectingOutputFormatterUsingAcceptHeaderAndExplicitContentTypes(logger, acceptHeader, mediaTypeCollection,
                null);
        }
        ...
        public static void NotMostEffectiveFilter(this ILogger logger, Type overridenFilter, Type overridingFilter,
            Type policyType)
        {
        ...
        {
            _cannotBindToFilesCollectionDueToUnsupportedContentType(logger, bindingContext.ModelName,
