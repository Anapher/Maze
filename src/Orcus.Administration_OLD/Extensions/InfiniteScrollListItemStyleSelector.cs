    ...
    public class InfiniteScrollListItemStyleSelector : StyleSelector
    {
        ...
        private void Init(ItemsControl infiniteScrollList)
        {
            if (PackageItemStyle == null && LoadingStatusIndicatorStyle == null)
            {
                ...
                {
                    PackageItemStyle.Setters.Add(new Setter(InfiniteScrollList.FocusVisualStyleProperty,
                        infiniteScrollList.FindResource("MarginFocusVisualStyle")));
                    PackageItemStyle.Setters.Add(new Setter(InfiniteScrollList.TemplateProperty,
                        infiniteScrollList.FindResource("ListBoxItemTemplate")));
                }
            }
        }
        ...
        public override Style SelectStyle(object item, DependencyObject container)
        {
            ...
            if (item is LoadingStatusIndicator) return LoadingStatusIndicatorStyle;
