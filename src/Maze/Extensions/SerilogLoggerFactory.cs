...
namespace Maze.Extensions
{
    ...
    public class SerilogLoggerFactory : ILoggerFactory
    {
        ...
        ///     logger is not specified but <paramref name="dispose" /> is true, the <see cref="Serilog.Log.CloseAndFlush()" /> method will
        ///     be
        ///     called on the static <see cref="Serilog.Log" /> class instead.
        /// </param>
