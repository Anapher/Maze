namespace DeviceManager.Administration.Utilities
{
    public static class DeviceErrorMessageUtilities
    {
        public static string GetErrorMessage(uint statusCode)
        {
            switch (statusCode)
            {
                case 0:
                ...
                default:
                    return $"Unknow status code ({statusCode})";
            }
        }
    }
}