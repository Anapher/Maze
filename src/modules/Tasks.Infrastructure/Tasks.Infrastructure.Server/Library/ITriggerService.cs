...
namespace Tasks.Infrastructure.Server.Library
{
    ...
    public interface ITriggerService<in TTriggerInfo> where TTriggerInfo : TriggerInfo
    {
        ...
        /// <returns>Return a task that once it completed, the trigger will be marked as completed and if all triggeres completed, the maze task will be finished.</returns>
