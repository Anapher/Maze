...
namespace Tasks.Infrastructure.Administration.Controls.PropertyGrid.Controls
{
    ...
    public class PathBox : TextBox
    {
        ...
        {
            get => (bool) GetValue(IsSelectingFileProperty);
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (Template.FindName("PART_OpenDialog", this) is Button openDialogButton)
            {
