...
namespace FileExplorer.Administration.Virtualization
{
    /// <summary>
    ...
    public class VirtualizingCollection<T> : IList<T>, IList
    {
        ...
        /// <param name="pageIndex">Index of the page.</param>
        /// <returns></returns>
        protected IList<T> FetchPage(int pageIndex) => ItemsProvider.FetchRange(pageIndex * PageSize, PageSize);

        /// <summary>
        ///     Fetches the count of itmes from the IItemsProvider.
        /// </summary>
        /// <returns></returns>
        protected int FetchCount() => ItemsProvider.FetchCount();
