...
{
    /// <summary>
    ///     Interaction logic for EditIntegerHexDecimalControl.xaml
    /// </summary>
    public partial class EditIntegerHexDecimalControl : UserControl
    {
        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register("Value", typeof(object),
            typeof(EditIntegerHexDecimalControl), new PropertyMetadata(0U, OnValueChanged));

        private bool _isSize64;

        public EditIntegerHexDecimalControl()
        {
            InitializeComponent();
        }
        ...
        {
            ((EditIntegerHexDecimalControl) d).OnValueChanged(e.NewValue);
        }
