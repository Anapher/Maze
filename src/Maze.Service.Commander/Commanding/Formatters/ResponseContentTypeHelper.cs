...
namespace Maze.Service.Commander.Commanding.Formatters
{
    public static class ResponseContentTypeHelper
    {
        ...
        ///     <see cref="HttpResponse.ContentType" /> property set
        ///     on <see cref="HttpResponse" />
        /// </param>
        ...
        public static void ResolveContentTypeAndEncoding(string actionResultContentType, string httpResponseContentType,
            string defaultContentType, out string resolvedContentType, out Encoding resolvedContentTypeEncoding)
        {
