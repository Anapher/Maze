    ...
    public class ModelStateDictionary : IReadOnlyDictionary<string, ModelStateEntry>
    {
        ...
        public bool TryAddModelError(string key, Exception exception, ModelMetadata metadata)
        {
            ...
            if (exception is FormatException || exception is OverflowException)
            {
                ...
                return TryAddModelError(key, $"Property {metadata.Name} is invalid ({entry.AttemptedValue})");
            }
        ...
        public void MarkFieldValid(string key)
        {
            ...
            {
                throw new InvalidOperationException("A field previously marked invalid should not be marked valid.");
            }
        ...
        public void MarkFieldSkipped(string key)
        {
            ...
            if (modelState.ValidationState == ModelValidationState.Invalid)
            {
                throw new InvalidOperationException("A field previously marked invalid should not be marked skipped.");
            }
        ...
        private void EnsureMaxErrorsReachedRecorded()
        {
            ...
            {
                var exception = new TooManyModelErrorsException("The maximum number of allowed model errors has been reached.");
