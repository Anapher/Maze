...
namespace Orcus.Administration.Modules.Models.Feed
{
    ...
    public abstract class PlainPackageFeedBase : IPackageFeed
    {
        ...
        public Task<SearchResult<IPackageSearchMetadata>> SearchAsync(string searchText, SearchFilter searchFilter,
        ...
        public abstract Task<SearchResult<IPackageSearchMetadata>> ContinueSearchAsync(
            ContinuationToken continuationToken, CancellationToken cancellationToken);

        public Task<SearchResult<IPackageSearchMetadata>> RefreshSearchAsync(RefreshToken refreshToken,
            CancellationToken cancellationToken)
        {
            return Task.FromResult(SearchResult.Empty<IPackageSearchMetadata>());
        }
    }
}