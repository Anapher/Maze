...
namespace Orcus.Server.Service.Commanding.Formatters
{
    ...
    {
        /// <summary>
        ///     Selects an <see cref="IOutputFormatter" /> to write the response based on the provided values and the current
        ///     request.
        /// </summary>
        /// <param name="context">The <see cref="OutputFormatterCanWriteContext" /> associated with the current request.</param>
        /// <param name="formatters">
        ///     A list of formatters to use; this acts as an override to
        ///     <see cref="MvcOptions.OutputFormatters" />.
        /// </param>
        ...
        public abstract IOutputFormatter SelectFormatter(OutputFormatterCanWriteContext context,
