...
namespace Orcus.ModuleManagement.Utilities
{
    /// <summary>
    ...
    {
        public const int MaxDegreeOfParallelism = 12;
        ...
        public static async Task<IReadOnlyDictionary<TSource, Exception>> ThrottledAsync<TSource>(IEnumerable<TSource> sources,
